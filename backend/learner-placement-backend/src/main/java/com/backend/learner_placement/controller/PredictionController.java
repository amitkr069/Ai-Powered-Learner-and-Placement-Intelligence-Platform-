...
import com.backend.learner_placement.services.PredictionService;
...
public class PredictionController {
	...
	public ResponseEntity<String> deletePrediction(@PathVariable Long predictionId){
		predictionService.deletePrediction(predictionId);
		return ResponseEntity.ok("Successfully deleted prediction with id : "+predictionId);
	}
