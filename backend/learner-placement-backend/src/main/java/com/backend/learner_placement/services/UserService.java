...
public class UserService {
	...
	public UserService(UserRepository userRepository, ModelMapper modelMapper,JwtUtil jwtUtil,AuthenticationManager authenticationManager,PasswordEncoder passwordEncoder) {
	...
	public AuthResponse loginUser(LoginRequest request) {
	    ...
	    AuthResponse response = modelMapper.map(existingUser, AuthResponse.class);
